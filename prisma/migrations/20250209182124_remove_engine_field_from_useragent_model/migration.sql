/*
  ...
  - You are about to drop the column `engine` on the `UserAgent` table. All the data in the column will be lost.
  - You are about to drop the column `engineVersion` on the `UserAgent` table. All the data in the column will be lost.
...
INSERT INTO "new_UserAgent" ("clientName", "clientType", "clientVersion", "deviceBrand", "deviceModel", "deviceType", "id", "osName", "osPlatform", "osVersion", "trackingId") SELECT "clientName", "clientType", "clientVersion", "deviceBrand", "deviceModel", "deviceType", "id", "osName", "osPlatform", "osVersion", "trackingId" FROM "UserAgent";
